...
== Description ==
Inspector will inspect your site for speed, security and performance. Your WordPress URL, Theme and Plugins are sent to https://app.inspector.dev where we run analysis on your WordPress and tell you how it performs.
...
Sometimes could be a slow plugin or a page with broken address. You will be able to know what's impacting your customer journey and anticipate their needs in real time and 24/7.

## How it works
Inspector collect execution information when users navigate your Wordpress website and send this data to your Inspector account to be analyzed. It do this job silently because it start to transfer data after your website
